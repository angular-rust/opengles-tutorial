use c06_pbr::{process_events, process_input, Camera, Shader};
use cgmath::prelude::*;
...
pub fn main() {
    ...
    let shader = {
        ...
        let shader = Shader::new(assets!("shaders/1.1.pbr.vs"), assets!("shaders/1.1.pbr.fs"));

        shader.use_program();
        shader.set_vec3("albedo", 0.5, 0.0, 0.0);
