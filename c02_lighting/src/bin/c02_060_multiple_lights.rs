...
pub fn main() {
    ...
    let (
        ...
        let lighting_shader =
            Shader::new(assets!("shaders/6.multiple_lights.vs"), assets!("shaders/6.multiple_lights.fs"));
        let lamp_shader = Shader::new(assets!("shaders/6.lamp.vs"), assets!("shaders/6.lamp.fs"));
    ...
    event_loop.run(move |event, _, control_flow| match event {
        ...
        Event::MainEventsCleared => {
            ...
            */
            ...
            // point light 1
            lighting_shader.set_vector3("pointLights[0].position", &point_light_positions[0]);
            ...
            // point light 2
            lighting_shader.set_vector3("pointLights[1].position", &point_light_positions[1]);
            ...
            // point light 3
            lighting_shader.set_vector3("pointLights[2].position", &point_light_positions[2]);
            ...
            // point light 4
            lighting_shader.set_vector3("pointLights[3].position", &point_light_positions[3]);
            ...
            // spotLight
            lighting_shader.set_vector3("spotLight.position", &camera.position.to_vec());
            lighting_shader.set_vector3("spotLight.direction", &camera.front);
            ...
            lighting_shader.set_float("spotLight.cutOff", 12.5f32.to_radians().cos());
            lighting_shader.set_float("spotLight.outerCutOff", 15.0f32.to_radians().cos());
            ...
            gl::bind_texture(GL_TEXTURE_2D, specular_map);
